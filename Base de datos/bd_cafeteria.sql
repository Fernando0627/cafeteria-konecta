...
CREATE TABLE `producto` (
  ...
  `pro_fecha` varchar(150) NOT NULL,
  `pro_stock` varchar(150) NOT NULL,
  `pro_categoria` varchar(150) NOT NULL,
  `pro_precio` varchar(150) NOT NULL,
  `pro_referencia` varchar(150) NOT NULL,
  `pro_peso` varchar(150) NOT NULL 
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
