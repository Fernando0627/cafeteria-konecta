...
public class Frm_Productos extends javax.swing.JInternalFrame {
    ...
    private void guardar(){
        ...
        String tmp_fecha = fecha.getText();
        String st_stock = stock.getText();
        String ca_categoria = categoria.getText();
        String pr_precio = precio.getText();
        String re_referencia = referencia.getText();
        String pe_peso = peso.getText();
        
                

        if(num == 0){
            int respuesta = CP.registrarProducto(codigo,descripcion,tmp_fecha, st_stock, ca_categoria, pr_precio, re_referencia, pe_peso);
            if(respuesta > 0){
            ...
            int respuesta = CP.actualizarProducto(codigo, descripcion,tmp_fecha, st_stock, ca_categoria, pr_precio, re_referencia, pe_peso, codigo_old);
            if(respuesta >0){
                listar();
                limpiar();
                iniciar();
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(categoria, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(22, 22, 22)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(precio, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jLabel6, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(peso, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(31, 31, 31)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(referencia, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
